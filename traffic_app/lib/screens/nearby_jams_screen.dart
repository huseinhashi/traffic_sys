...
class _NearbyJamsScreenState extends State<NearbyJamsScreen> {
  ...
  Future<void> _fetchNearbyPosts() async {
    ...
    if (locationProvider.latitude != null &&
      ...
      // Create notifications for nearby jams
      for (final post in postsProvider.nearbyJamPosts) {
        await notificationProvider.createNearbyJamNotification(
          jamPostId: post.id.toString(),
